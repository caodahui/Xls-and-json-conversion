let en = {
  // lingo-start
  "hotcoinApp_v1_3_11218_OrderFailedCurrentlyThere": "Order failed! Currently there is a position/commission with an order, and this account is not available",
  "hotcoinApp_v1_3_11218_SwitchFailedCurrentlyThere": "Switch failed! Currently there is a position/commission with an order",
  "hotcoinApp_v1_3_11218_ContractBonusValue0Pieces": "Contract bonus {{value_0}} units",
  "hotcoinApp_v1_3_11218_Value0PiecesOfFinancial": "{{value_0}} units of financial experience bonus",
  "hotcoinApp_v1_3_11218_Value0ContractFeeDiscount": "{{value_0}} contract fee discount coupons",
  "hotcoinApp_v1_3_11218_ContractExperienceBonusValue0": "Contract experience bonus {{value_0}} units",
  "hotcoinApp_v1_22_09_CustomerServiceExplanation": "Customer service guide",
  "hotcoinApp_v1_22_09_Reply": "reply",
  "hotcoinApp_v1_3_11218_ContractTradingFund_1": "Contract Trading Fund",
  "hotcoinApp_v1_3_11218_ContractTradingFundValue0": "Contract trading fund {{value_0}} units",
  "hotcoinApp_v1_2224_TheAboveDataOnly": "The above data only shows the latest 10 items. If you need more data, please contact customer service",
  "hotcoinApp_v1_2224_TheDevicesYouSelected": "The devices you selected include the current device. After removing the selected device, the selected device will be exited immediately",
  "hotcoinApp_v1_2224_RemoveTheCurrentAccount": "Remove the current account and log out to the login page immediately",
  "hotcoinApp_v1_22_29_UnlockableGundam": "Unlockable Gundam",
  "hotcoinApp_v1_22_29_OnlyNewUsersWith": "Only new users with a first deposit of 500 USDT or more can unlock the event~",
  "hotcoinApp_v1_2224_RemoveDeviceRemoveDeviceValue0": "Remove device ({{value_0}})",
  "hotcoinApp_v1_12_2_10_Sustainable": "Perpetual",
  "hotcoinApp_v1_1_10_GetUpToValue0": "Get up to {{value_0}} USDT reward",
  "hotcoinApp_v1_1_10_ScanTheQRCode": "Scan the QR code to register Hotcoin",
  "hotcoinApp_v1_1_10_InviteCode": "Referral ID",
  "hotcoinApp_v1_1_10_SecondSeason": "Bi-Quarterly",
  "hotcoinApp_v1_1_10_Season": "Quarterly",
  "hotcoinApp_v1_1_10_NextWeek": "Bi-Weekly",
  "hotcoinApp_v1_1_10_ThisWeek": "Weekly",
  "hotcoinApp_v1_2224_RemoveAccountvalue0": "Remove account({{value_0}})",
  "hotcoinApp_v1_2224_RemoveAccount": "Remove Account",
  "hotcoinApp_v1_2224_RemoveAllAccounts": "Remove all accounts",
  "hotcoinApp_v1_2224_RemoveCurrentAccount": "Remove current account",
  "hotcoinApp_v1_2224_TheAccountYouSelected": "The account you selected includes the current account. After removing the selected account, the selected account will require multiple verifications when logging into the device next time.",
  "hotcoinApp_v1_2224_AfterRemovingTheSelected_1": "After removing the selected account, the selected account will need multiple verifications to log in to the device next time",
  "hotcoinApp_v1_2224_AfterRemovingTheSelected": "After removing the selected device, the selected device will be exited immediately",
  "hotcoinApp_v1_2224_RemoveTheCurrentDevice_1": "Remove the current device and you will be immediately logged out to the login page",
  "hotcoinApp_v1_2224_RemoveCurrentDevice": "Remove current device",
  "hotcoinApp_v1_2224_Closure": "Disable",
  "hotcoinApp_v1_2224_ContactCustomerService": "Contact Customer Service",
  "hotcoinApp_v1_2224_TheUpperLimitOf": "The upper limit of login/registered accounts for this device exceeds 10, please contact customer service",
  "hotcoinApp_v1_2224_CurrentAccount_1": "Current Account",
  "hotcoinApp_v1_2224_EachDeviceOnlySupports": "Each device only supports 10 accounts to log in. If more than 10 accounts are logged in, you will not be able to log in and need to delete other accounts. Current number of accounts: {{value_0}}",
  "hotcoinApp_v1_2224_Remove2": "Remove({{value_0}})",
  "hotcoinApp_v1_2224_Remove1": "Remove({{value_0}})",
  "hotcoinApp_v1_2224_LoginDeviceQuery": "Login device query",
  "hotcoinApp_v1_2224_CurrentDevice_1": "Current Device",
  "hotcoinApp_v1_2224_CurrentDeviceAccount": "Current device account",
  "hotcoinApp_v1_2224_CurrentAccountLoggedIn": "Current account logged in device",
  "hotcoinApp_v1_2224_IPAddress": "IP Address:",
  "hotcoinApp_v1_2224_LoginAddressSingapore": "Login address:",
  "hotcoinApp_v1_2224_Remove_1": "Remove",
  "hotcoinApp_v1_2224_RemoveAllDevices": "Remove All Devices",
  "hotcoinApp_v1_2224_YouAreUsingA": "You are using a new device to log in to this account. We will perform multi-factor authentication",
  "hotcoinApp_v1_2224_LoginDevice": "Login device",
  "hotcoinApp_v1_22_29_FrequentRequestsPleaseTry": "Frequent requests, please try again later",
  "hotcoinApp_v1_22_29_ThisActivityIsOnly": "This activity is only available to new users",
  "hotcoinApp_v1_22_01_Assets": "Assets",
  "hotcoinApp_v1_2222223_FundingKeyVerification": "Funding key verification",
  ...
  "hotcoinApp_v1_22_29_DepositAfterRegistrationThe": "After successful registration, if the first deposit is ≥ 500 USDT (excluding intra-site transfers), you will receive a corresponding 40% bonus.",
  ...
  "hotcoinApp_v1_3_11218_GoToView": "View",
  "hotcoinApp_v1_22_01_ThisUserWillBe_1": "This user will be unblocked on {{value_0}}",
  "hotcoinApp_v1_3_11218_RiskControl": "Risk control",
  ...
  "hotcoinApp_v1_3_11218_WhenTheAccountEquity": "When the account equity is ≥{{value_0}}USDT or ≤{{value_1}}USDT, the voucher expires. Upon expiration, the current order will be cancelled, and the current position will be closed at the market price.",
  ...
  "hotcoinApp_v1_3_11218_ProfitSettlementTransfer": "Profit transfer",
  "hotcoinApp_v1_3_11218_CloseOutSettlement": "Close Settlement",
  "hotcoinApp_v1_3_11218_Funding": "Funding Fee",
  "hotcoinApp_v1_3_11218_FailureRecovery": "Expired recovery",
  ...
  "hotcoinApp_v1_3_11218_PleaseUseTheCoupon": "Please use the coupon before it expires. Upon expiration, orders will be cancelled, and positions will be closed at market price.",
  "hotcoinApp_v1_3_11218_UseExpirationTime": "Use expiration time",
  "hotcoinApp_v1_3_11218_AccountEquityAtThe": "(Account equity upon recovery - trading fund face value) * profit ratio",
  "hotcoinApp_v1_3_11218_Profitable": "Earned profit",
...
{{color_0}}Instant credit, no fees. No refunds.{{color_0}}",
  ...
  "hotcoinApp_v1_3_8_1WhenTheMargin": "1. When the margin required for the position is lower than the available bonus, the bonus will be used first. If it is higher than the available bonus, the bonus and the funds of the contract account will be used to open a position together. \n2. The bonus part cannot be transferred.",
