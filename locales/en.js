let en = {
  ...
  "hotcoinApp_v1_2224_TheAccountYouSelected": "The account you selected includes the current account. After removing the selected account, the selected account will need multiple verifications when logging into the device next time.",
  ...
  "hotcoinApp_v1_2224_EachDeviceOnlySupports": "Each device only supports 10 accounts to log in. If more than 10 accounts are available, you will not be able to log in and need to delete other accounts. Current number of accounts: {{value_0}}",
